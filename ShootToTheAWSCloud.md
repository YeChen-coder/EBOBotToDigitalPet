打算开了branch 把项目移到AWS上去了，因此引发的一连串问题和对解决方案的探索。-补：后来又考虑了一下。因为现在加了 diagnostic agent，又跟云端那边做了一些联动，导致它跟当前上传的这个项目分歧有点太大了。我觉得在当前项目里开 branch 可能不是一个很好的选择。所以后续等我调得差不多、要发上来的时候，我会建一个新的 repository，而不是在这里面开 branch。-再补，算了还是放这里的main吧，repository多了我自己都看着麻烦。
...
其实真的就感觉，把事情跑通了然后再回去看，就能发现里边真的有好多好多能说的东西啊。比如我现在真的很想抓个人吐槽，倒也没那么艰辛，我就是纯粹很想吐槽，这旺盛的表达欲无处发泄。

随便捞出一点东西，我都能絮絮叨叨叭叭上半天：

• 这个东西为什么要这么搞？

• 为什么这边要这么设计，它怎么就成这个样子了？

• 为什么最开始给我的 dashboard 和那堆一线检查全是没有用的东西？

当然还有解决不了的问题，比如为什么 Codex 这么不耐用啊？以及为什么在这个年代还能有 power outage 这种事？Canada不是发达国家吗？这边也没下那么大的暴风雪呀。
